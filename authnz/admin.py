...
class UserAdmin(admin.ModelAdmin):
    ...
    def get_search_results(self, request, queryset, search_term):  # filter auto complete list in django admin
        queryset, use_distinct = super().get_search_results(request, queryset, search_term)
        if 'autocomplete' in request.path:  # to not filter list item in category section
